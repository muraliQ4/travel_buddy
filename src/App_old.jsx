  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch weather for both locations (but don't fail if weather API is down)
        try {
          ...
          console.warn('Weather data unavailable (API key may not be activated yet):', weatherError.message);
